var rule = {
    ...
    一级: async function () {
        ...
        let b = 'device=20caaae96b3443174bf4ebdbdcc253776';
        let xx = JSON.stringify({b});
        let head = JSON.parse(await post(tkurl, {
        ...
        let html = JSON.parse(await request(urlk, {
            headers: header
        }));
    ...
    搜索: async function () {
        ...
        let html = JSON.parse(await post(ser, {
            headers: header,
            body: "text=" + ht
        }));
