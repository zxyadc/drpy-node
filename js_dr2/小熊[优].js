...
globalThis.jxx = function (id, url,name,juji) {
    ...
    if (id.startsWith('http')) {
        return  { parse: 1, url: id+url , jx: 0,danmaku: 'http://103.45.162.207:25252/hbdm.php?key=789456123&id=' + '&jm=' + name + '&js=' + juji + '&key=789456123'};
    }
     if (id == 0) {
        return  { parse: 0, url: id+url , jx: 1,
        danmaku: 'http://103.45.162.207:25252/hbdm.php?key=789456123&id=' + '&jm=' + name + '&js=' + juji + '&key=789456123'};
    }   
