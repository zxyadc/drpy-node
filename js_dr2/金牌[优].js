...
globalThis.vodlist = function (t, pg) {
    ...
    let html = fetch('https://m.hkybqufgh.com/api/mw-movie/anonymous/video/list?' + 'area=&pageNum=' + pg + '&type1=' + t + '&year=', options)
...
globalThis.vodids = function (ids) {
    ...
    let html = fetch('https://m.hkybqufgh.com/api/mw-movie/anonymous/video/detail?id=' + ids, options)
...
globalThis.svodlist = function (wd) {
    ...
    let html = fetch('https://m.hkybqufgh.com/api/mw-movie/anonymous/video/searchByWord?keyword=' + wd + '&pageNum=1&pageSize=8', options)
...
globalThis.jxx = function (id, nid) {
    ...
    let html = fetch('https://m.hkybqufgh.com/api/mw-movie/anonymous/v1/video/episode/url?id=' + id + '&nid=' + nid, options)
