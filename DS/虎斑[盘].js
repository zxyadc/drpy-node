globalThis.host1 = 'http://103.45.162.207:20720/';
globalThis.host2 = '';
globalThis.host3 = '';
globalThis.host4 = '';
...
class_parse: async function () {
    ...
    // 使用 Set 来存储已出现的 typeName
    let uniqueTypeNames = new Set();
    data.forEach((it, index) => {
        let typeName = pdfh(it, 'a&&Text'); // 提取文本内容
        // 如果 typeName 还未出现过，进行处理
        if (!uniqueTypeNames.has(typeName)) {
