var rule = {
    ...
    lazy: async function (flag, id, flags) {
     ...
     //   https://hhjx.hhplayer.com/cache/bf/9b3b37e82595b984d900046d8f1923c4.m3u8
        return {
        parse: 0,
        url: js_html.url.replace(/\/cache(\/|$)/g, 'https://hhjx.hhplayer.com/cache$1')
    }
   }
};
