var rule = {
    ...
    Encrypt: function(plainText) {
        let encrypted = CryptoJS.AES.encrypt(plainText, this.cryptoConfig.key, {
            iv: this.cryptoConfig.iv,
    ...
    // 公共请求函数
    gethtml: async function (u, body, headers) {
        ...
        var bodykeyiv = JSON.parse(RSA.decode(keys, ""));
        var key = CryptoJS.enc.Utf8.parse(bodykeyiv.key);
        var iv = CryptoJS.enc.Utf8.parse(bodykeyiv.iv);
        var html = this.Decrypt(response_key, key, iv);
        return html;
    },
    // 公共子分类函数
    hqsub: function (MY_CATE) {
...
// 构造 VOD 对象
    ...
    搜索: async function () {
        ...
        // 构造请求参数
        const request_key = JSON.stringify({ "keywords": request_key11, "order_val": "1" });
