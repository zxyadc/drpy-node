...
var rule = {
    ...
    class_url: '0&1&2&3',
    url: '/jj.php/getappapi.index/typeFilterVodList?fyfilter',
    filter_url: 'area=全部&year={{fl.year or "全部"}}&type_id=fyclass&page=fypage&sort={{fl.sort or "最新"}}&lang=全部&class=全部',
    detailUrl: '/jj.php/getappapi.index/vodDetail?vod_id=fyid',
    searchUrl: '/jj.php/getappapi.index/searchList?keywords=**&type_id=0&page=fypage',
    searchable: 1,
    filterable: 1,
    quickSearch: 0,
    headers: {
    ...
    */
    ...
    lazy: async function (flag, id, flags) {
        ...
        let html = await post(rule.host + '/jj.php/getappapi.index/vodParse', {
            headers: {
                'User-Agent': ua
            },
